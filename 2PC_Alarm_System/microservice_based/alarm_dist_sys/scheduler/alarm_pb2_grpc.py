...
class TwoPCCoordinatorStub(object):
    ...
    def __init__(self, channel):
        ...
        Args:
            channel: A grpc.Channel.
        """
        self.AddAlarm2PC = channel.unary_unary(
                '/alarm.TwoPCCoordinator/AddAlarm2PC',
                request_serializer=alarm__pb2.AddAlarmRequest.SerializeToString,
                response_deserializer=alarm__pb2.Ack.FromString,
                _registered_method=True)
...
def add_TwoPCCoordinatorServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'AddAlarm2PC': grpc.unary_unary_rpc_method_handler(
                    servicer.AddAlarm2PC,
                    request_deserializer=alarm__pb2.AddAlarmRequest.FromString,
                    response_serializer=alarm__pb2.Ack.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'alarm.TwoPCCoordinator', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('alarm.TwoPCCoordinator', rpc_method_handlers)
...
class TwoPCCoordinator(object):
    ...
    def AddAlarm2PC(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/alarm.TwoPCCoordinator/AddAlarm2PC',
            alarm__pb2.AddAlarmRequest.SerializeToString,
            alarm__pb2.Ack.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
...
class VotePhaseStub(object):
    ...
    def __init__(self, channel):
        ...
        Args:
            channel: A grpc.Channel.
        """
        self.VoteOnAddAlarm = channel.unary_unary(
                '/alarm.VotePhase/VoteOnAddAlarm',
                request_serializer=alarm__pb2.VoteRequest.SerializeToString,
                response_deserializer=alarm__pb2.VoteResponse.FromString,
                _registered_method=True)
...
def add_VotePhaseServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'VoteOnAddAlarm': grpc.unary_unary_rpc_method_handler(
                    servicer.VoteOnAddAlarm,
                    request_deserializer=alarm__pb2.VoteRequest.FromString,
                    response_serializer=alarm__pb2.VoteResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'alarm.VotePhase', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('alarm.VotePhase', rpc_method_handlers)
...
class VotePhase(object):
    ...
    def VoteOnAddAlarm(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/alarm.VotePhase/VoteOnAddAlarm',
            alarm__pb2.VoteRequest.SerializeToString,
            alarm__pb2.VoteResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
...
class DecisionPhaseStub(object):
    ...
    def __init__(self, channel):
        ...
        Args:
            channel: A grpc.Channel.
        """
        self.AddPreparedAlarm = channel.unary_unary(
                '/alarm.DecisionPhase/AddPreparedAlarm',
                request_serializer=alarm__pb2.PreparedAlarm.SerializeToString,
                response_deserializer=alarm__pb2.Ack.FromString,
                _registered_method=True)
        self.DecideOnAddAlarm = channel.unary_unary(
                '/alarm.DecisionPhase/DecideOnAddAlarm',
                request_serializer=alarm__pb2.DecisionRequest.SerializeToString,
                response_deserializer=alarm__pb2.Ack.FromString,
                _registered_method=True)
...
class DecisionPhaseServicer(object):
    ...
    def AddPreparedAlarm(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')

    def DecideOnAddAlarm(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_DecisionPhaseServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'AddPreparedAlarm': grpc.unary_unary_rpc_method_handler(
                    servicer.AddPreparedAlarm,
                    request_deserializer=alarm__pb2.PreparedAlarm.FromString,
                    response_serializer=alarm__pb2.Ack.SerializeToString,
            ),
            'DecideOnAddAlarm': grpc.unary_unary_rpc_method_handler(
                    servicer.DecideOnAddAlarm,
                    request_deserializer=alarm__pb2.DecisionRequest.FromString,
                    response_serializer=alarm__pb2.Ack.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'alarm.DecisionPhase', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('alarm.DecisionPhase', rpc_method_handlers)
...
class DecisionPhase(object):
    ...
    def AddPreparedAlarm(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/alarm.DecisionPhase/AddPreparedAlarm',
            alarm__pb2.PreparedAlarm.SerializeToString,
            alarm__pb2.Ack.FromString,
            options,
            channel_credentials,
            insecure,
    ...
    def DecideOnAddAlarm(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/alarm.DecisionPhase/DecideOnAddAlarm',
            alarm__pb2.DecisionRequest.SerializeToString,
            alarm__pb2.Ack.FromString,
            options,
            channel_credentials,
            insecure,
